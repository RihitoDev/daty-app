...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleRegister() async {
    ...
    if (errorCode != null) {
      String message = 'Ocurrió un error inesperado. Inténtalo nuevamente.';

      if (errorCode == 'weak-password') {
        message = 'La contraseña es muy débil. Usa mínimo 6 caracteres.';
      } else if (errorCode == 'email-already-in-use') {
        message = 'Este correo ya está registrado.';
      } else if (errorCode == 'username-taken') {
        message =
            'Este nombre de usuario ya está en uso. Elige otro diferente.';
                    ...
                    Align(
                      ...
                      child: IconButton(
                        icon: Icon(Icons.arrow_back_ios_new,
                            color: customTheme.text, size: 20),
                        ...
                        children: [
                          Container(
                            ...
                            child: Icon(Icons.auto_awesome,
                                color: customTheme.primary, size: 32),
                          ),
                              ...
                              children: [
                                Text('Crea tu cuenta hoy',
                                    style: TextStyle(
                                        ...
                                        letterSpacing: -0.5)),
                                Text('Comienza tu aventura junto a Daty',
                                    style: TextStyle(
                                        fontSize: 13,
  ...
  Widget _buildStepIndicator(
      int step, String title, AppCustomTheme customTheme) {
    return Row(
      children: [
        Container(
          width: 24,
            ...
            Expanded(
              child: ClipRRect(
                ...
                child: LinearProgressIndicator(
                  ...
                  minHeight: 6,
                  backgroundColor:
                      _passwordStrengthColor.withValues(alpha: 0.15),
                  valueColor:
      ...
      children: [
        Positioned(
            ...
            child: Icon(Icons.star_rounded,
                color: primaryColor.withValues(alpha: 0.05), size: 120)),
        Positioned(
            bottom: 150,
            left: -30,
            child: Icon(Icons.explore_outlined,
                color: primaryColor.withValues(alpha: 0.05), size: 150)),
      ],
    );
  }
}
