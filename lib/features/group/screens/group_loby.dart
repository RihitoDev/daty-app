        ...
        builder: (context, groupProvider, _) {
          ...
          return Scaffold(
            ...
            body: FutureBuilder<DocumentSnapshot>(
              // Obtenemos los datos del usuario para ver sus recuerdos guardados/ignorados
              ...
              builder: (context, userSnapshot) {
                ...
                return FutureBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    // Lógica clave: ¿Ya guardó o ya ignoró este recuerdo?
                    bool wasSaved = savedMemories.contains(memoryDocId);
                    bool wasDismissed = dismissedMemories.contains(memoryDocId);

                    // Si lo ignoró, no mostramos la tarjeta (pasamos null)
                    // Si lo guardó, mostramos la tarjeta en modo "nostálgico"
                    if (wasDismissed) {
                      return _buildMainContent(context, groupProvider, null, false);
                    }
      ...
      child: Column(
        children: [
          ...
          if (lastAdventureDoc != null) ...[
            if (wasSaved) 
              const Text('Hace poco disfrutaron:', style: TextStyle(color: Colors.black54, fontWeight: FontWeight.bold, fontSize: 16))
            else 
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (_) => GroupMemoryBoardScreen(
          ...
          isReviewingPastMemory: wasSaved, // ¡Le decimos a la pantalla si ya lo guardó!
        )));
      },
      child: Container(
