...
class GroupLobby extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) =>
          GroupProvider(Provider.of<AuthProvider>(context, listen: false)),
        ...
        builder: (context, groupProvider, _) {
          ...
          return Scaffold(
            ...
            appBar: isInRoom
                ? null
                : AppBar(
                    title: const Text('Aventura Grupal',
                        style: TextStyle(
            ...
            body: AnimatedSwitcher(
              ...
              child: isInRoom
                  ? GroupRoom(
                      key: ValueKey(groupProvider.currentGroupCode),
                      groupCode: groupProvider.currentGroupCode!)
                  : FutureBuilder<DocumentSnapshot>(
                      ...
                      builder: (context, userSnapshot) {
                        ...
                        final userData = userSnapshot.data!.data()
                            ...
                            {};
                        final List<dynamic> dismissedMemories =
                            userData['dismissedGroupMemories'] ?? [];
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (!snapshot.hasData ||
                              ...
                              return _buildMainContent(
                                  context, groupProvider, null, false);
                            }
                            ...
                            final List<dynamic> savedBy = List<dynamic>.from(
                                memoryData?['savedBy'] ?? []);

                            bool wasSaved = savedBy.contains(myUid);
                            bool wasDismissed =
                                dismissedMemories.contains(memoryDocId);
                            ...
                            return _buildMainContent(
                                context, groupProvider, lastDoc, wasSaved);
                          },
                        );
                      },
                    ),
  ...
  Widget _buildMainContent(BuildContext context, GroupProvider groupProvider,
      DocumentSnapshot? lastAdventureDoc, bool wasSaved) {
    return SingleChildScrollView(
      padding:
          EdgeInsets.all(MediaQuery.sizeOf(context).width <= 360 ? 16 : 30),
      child: Column(
        children: [
          const Icon(Icons.groups_rounded, size: 80, color: Color(0xFF8E24AA)),
          const SizedBox(height: 10),
          const Text('¡La unión hace la fuerza!',
          ...
          if (lastAdventureDoc != null) ...[
            Text(wasSaved ? 'Hace poco disfrutaron:' : 'Tu última aventura:',
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: groupProvider.isLoading
                  ...
                  : const Text('Iniciar Nueva Expedición',
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 18,
                          fontWeight: FontWeight.bold)),
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              ...
              onPressed: groupProvider.isLoading
                  ? null
                  : () => _showJoinDialog(context, groupProvider),
  ...
  Widget _buildLastAdventureCard(
      BuildContext context, DocumentSnapshot doc, bool wasSaved) {
    ...
    return GestureDetector(
            ...
            MaterialPageRoute(
                builder: (_) => GroupMemoryBoardScreen(
                      ...
                      adventureData: {
                        'title': title,
                        'emoji': emoji,
                        'number': int.tryParse(data['id_adventure'] ?? '0') ?? 0
                      },
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: wasSaved
              ? Border.all(
                  color: const Color(0xFF8E24AA).withOpacity(0.3), width: 2)
              : null,
        ),
        child: Column(
              ...
              Container(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    Text('${photos.length} fotos subidas',
                        style: const TextStyle(
                            color: Color(0xFF8E24AA),
                            fontWeight: FontWeight.bold,
                            fontSize: 13)),
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
              ...
              child:
                  const Text('Unirse', style: TextStyle(color: Colors.white))),
        ],
      ),
